...
func (cfg Config) GetPFlagSet(prefix string) *pflag.FlagSet {
	...
	cmdFlags.String(fmt.Sprintf("%v%v", prefix, "googleTokenSource.type"), defaultConfig.GoogleTokenSource.Type, "Defines type of TokenSourceFactory,  possible values are 'default' or 'gke'")
	...
	cmdFlags.String(fmt.Sprintf("%v%v", prefix, "googleTokenSource.gkeClusterURL"), defaultConfig.GoogleTokenSource.GKEClusterURL, "Defines URL to GKE cluster,  e.g. https://container.googleapis.com/v1/projects/<project>/locations/<location>/clusters/<cluster>")
